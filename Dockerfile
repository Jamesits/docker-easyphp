...
RUN apt-get update \
	&& apt-get upgrade -y \
	&& apt-get install -y libgmp-dev libpng-dev libjpeg-dev zlib1g-dev libcurl4-gnutls-dev libldb-dev libldap2-dev libmcrypt-dev libfreetype6-dev libbz2-dev libxml2-dev libzip-dev libpq-dev less sudo\
